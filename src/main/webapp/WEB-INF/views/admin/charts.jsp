                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">상품별 매출액</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <code>/resources/js/demo/chart-area-demo.js</code> file.
                                </div>
                            </div>
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc','#4e73dd', '#1cc88e', '#36b9cf'],
